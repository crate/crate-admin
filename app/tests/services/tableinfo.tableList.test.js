  ...
  describe('mockTableList', function() {
    it('should return table list object', inject(function() {
      ...
      var result = mockTableList.execute([{
          ...
          size: 3578,
          summary: "1 TABLE.RECORDS_UNDERREPLICATED / 4 TABLE.SHARDS_UNDERREPLICATED / 4 TABLE.SHARDS / 1 TABLE.REPLICAS",
          table_schema: "doc",
          ...
          shards_underreplicated: 4,
          size: 636,
          summary: "4 TABLE.SHARDS_UNDERREPLICATED / 4 TABLE.SHARDS / 1 TABLE.REPLICAS",
          table_schema: "doc",
          type_display_name: "TABLE.RECORDS"
        }], [{
          avg_docs: 0.25,
