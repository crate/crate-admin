      ...
      link: function($scope, element, attrs, $console) {
        ...
        window.CodeMirror.defineMIME('text/x-cratedb', {
          ...
          keywords: KeywordObjectCreator.create([
           ...
           'grouping', 'groups', 'gt', 'gte', 'handler', 'has_database_privilege', 'having', 'hold',
           ...
           'materialized', 'max', 'max_by', 'member', 'merge', 'method', 'min', 'min_by', 'minus',
           ...
           'over', 'overlaps', 'overlay', 'pad', 'parameter', 'parse_uri', 'parse_url', 'partial',
